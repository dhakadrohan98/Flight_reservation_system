...
public class FlightController {
    ...
    public String displayFindFlights() {
        return "findFlights"; // Assuming "findFlights" is the name of your Thymeleaf template
    }
    ...
    public String findFlights(@RequestParam("from") String from, @RequestParam("to") String to,
        ...
        return "displayFlights"; // Assuming "displayFlights" is the name of your Thymeleaf template
    }
}